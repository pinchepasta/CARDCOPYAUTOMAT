...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull FrameLayout rootView, @NonNull TextView fileNameText,
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemImageBinding((FrameLayout) rootView, fileNameText, imageView);
    }
